  ...
  <div class="container">  
      <div class="row d-flex justify-content-center">
        <div class="col-md-12 text-center">
              <h6 class="text-danger"> Click on a class/Event to view a list of those who have boooked./h6>
        </div>
      </div>
        ...
        <div class=" d-flex justify-content-between mt-1">
              ...
              <div class="">
                @if ( date('W') < $monthf['week'] ) 
                  <form id="getPrevWeek" action="/adminschedule" method="post">
                    @csrf
            ...
            <div class="">
              <form id="getNextWeek" action="/adminschedule" method="post">
                @csrf
                            ...
                            @if($key == $daysArr[$i])
                              ...
                              @if( $dateToday1 == $daysArr[$i] ) 
                                <div class="today" id="todayClass">
                                    ...
                                    <a href="classbookings/{{$class->id}}"  class="d-block" >
                                      <div class="col-md-auto" id="myTooltip" data-toggle="tooltip" data-placement="right" title=" {{$class->desc}} ">
                                        ...
                                        @endphp
                                      {{ $startTimeF }} <br>
                                      {{ (int)(((strtotime($class->finish) - strtotime($class->start))/60)) }} Mins
                                      </div>
                                    </a>
                                    <hr>
                                </div>
                    ...
                    success: function (response, status, xhr) {
                      ...
                      if (count == 0) {
                          ...
                          $.each( response, function( key, value ) {
                            ...
                            $('#ajaxAppend').append('<div class="col-sm-1 w-100 text-center"><a href="classbookings/'+value.id+'" class="" ><div class="col-sm-auto" id="myTooltip" data-toggle="tooltip" data-placement="right" title="'+value.desc+'">'+ value.title +' <br>'+ moment(value.start).format('HH:mm') +' <br>'+ duration +' Mins </div></a><hr></div>');
                          });
                      }
                    },
