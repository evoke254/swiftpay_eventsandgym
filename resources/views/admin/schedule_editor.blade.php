  ...
  <div class="row m-4 p-4 d-flex justify-content-center">
      <div class="col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center">
          <div class="card m-4 p-4">
            <div class="card-body" >
              <button class="btn btn-sm btn-dark-green" id="createEvent"><i class="ion-ios-add-circle-outline"></i> Add Event</button>
              <div id='calendar'></div>
            </div>
          </div>
      </div>
...
<div class="modal fade" id="createKahakiEvent" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h4 class="modal-title w-100" id="myModalLabel">Create New Calendar</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-12">
                          <select name="classOrEvent" id="classOrEvent" class="form-control">
                              <option value="0" selected="selected" disabled>Is this a class or Event?</option>
