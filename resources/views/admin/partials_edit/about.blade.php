		...
		<div id="about" class="content" data-scrollview="true">
			...
			<div class="container" data-animation="true" data-animation-type="fadeInDown">
				<h2 class="content-title dark-green">About Us</h2>
				...
				<div class="row">
					...
					<!-- begin col-4 -->
					<div class="col-md-4 col-sm-12">
						<h3 class="dark-green" >Our Philosophy</h3>
						<!-- begin about-author -->
						<div class="about-author">
							...
							<div class="author">
								<div class="image">
									<img class="img-responsive" src="{{ asset('images/Shots_logo_s.png') }}">
								</div>
								<div class="info">
									Sean Ngu
					...
					<!-- begin col-4 -->
					<div class="col-md-4 col-sm-12">
						<h3 class="dark-green">Our Experience</h3>
						<!-- begin skills -->
						<div class="skills">
